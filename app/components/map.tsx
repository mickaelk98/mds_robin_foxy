                            ...
                            {selectedRegion && selectedRegion.boutiques.length > 0 ? (
                                <ul className="mt-4 space-y-4">
                                    {selectedRegion.boutiques.map((boutique) => (
                                        <li key={boutique.id} className="p-3 border rounded-xl flex flex-col gap-1">
                                            <span className='font-semibold mb-1'>{boutique.name}</span>
                                            <span className="text-xs">{boutique.phone} — {boutique.email}</span>
